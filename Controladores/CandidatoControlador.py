...
class CandidatoControlador():
    def __init__(self):
        """
        Constructor de la clase candidato controlador
        """
    ...
    def create(self, infoCandidato):
        """
        Crear candidato
        :param infoCandidato: Información candidato
        :return: Candidato nuevo
        """
